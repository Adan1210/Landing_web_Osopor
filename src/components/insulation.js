        ...
        <div class="insulation-grid" style="display:grid;grid-template-columns:5fr 7fr;gap:96px;align-items:center;">
          <div style="display:flex;flex-direction:column;gap:48px;">
            <div style="display:flex;flex-direction:column;gap:24px;">
              <h2 style="font-size:48px;line-height:1.15;letter-spacing:-0.03em;font-weight:600;color:#001F3F;margin:0;">${esc(t.insulation.h2)}</h2>
              <p style="font-size:18px;line-height:1.6;letter-spacing:-0.01em;color:#5e5e5e;margin:0;">${esc(t.insulation.body)}</p>
            </div>
            <div style="display:flex;flex-direction:column;gap:32px;">
              <div style="background:#ffffff;padding:24px;border-radius:1rem;box-shadow:0 1px 2px 0 rgba(0,31,63,0.05);border:1px solid #E7E7E4;">
