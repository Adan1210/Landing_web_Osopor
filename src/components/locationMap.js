...
export function renderLocationMap(t) {
  return `
    <section style="width:100%;padding:0 0 88px;background:#f7f7f5;">
      <div style="max-width:1280px;margin:0 auto;padding:0 32px;">
        <div class="location-section" style="width:100%;height:480px;position:relative;overflow:hidden;border-radius:2rem;">
          ...
          <a href="https://maps.app.goo.gl/MhPppojozYP6gXLcA" target="_blank" rel="noopener noreferrer" style="position:absolute;bottom:32px;left:50%;transform:translateX(-50%);display:inline-flex;align-items:center;gap:8px;font-size:12px;font-weight:600;letter-spacing:0.1em;color:#001F3F;background:rgba(255,255,255,0.95);backdrop-filter:blur(8px);padding:12px 20px;border-radius:9999px;box-shadow:0 10px 15px -3px rgba(0,31,63,0.15);">
