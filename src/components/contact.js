...
import contactBg from "../assets/images/contact-call-center.webp";
...
export function renderContact(t) {
  ...
  return `
    <section style="padding:100px 0 120px 0;background:linear-gradient(rgba(247,247,245,0.93),rgba(247,247,245,0.93)),url(${contactBg}) center 20%/cover no-repeat;">
      <div class="contact-grid" style="max-width:1280px;margin:0 auto;padding:0 32px;display:grid;grid-template-columns:1fr 1fr;gap:96px;">
        ...
        <div class="contact-form" style="background:#FCFCFB;padding:48px;border-radius:2rem;border:1px solid #E7E7E4;box-shadow:0 1px 2px 0 rgba(0,31,63,0.05);">
          <form id="contact-form" style="display:flex;flex-direction:column;gap:24px;">
            ...
            <button type="button" id="submit-btn" class="submit-btn" style="width:100%;background:#001F3F;color:#ffffff;padding:20px;border-radius:0.75rem;border:none;font-size:12px;font-weight:600;letter-spacing:0.1em;cursor:pointer;">${esc(t.contact.form.submit)}</button>
          </form>
        </div>
      </div>
    </section>
